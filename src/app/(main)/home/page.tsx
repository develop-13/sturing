"use client";
import Button from "@/components/header_metarials/Button";
    ...
    <>
      ...
      <div>
        <button
          ...
          onClick={() => "스터디 이동 링크"}
        >
          <text className="font-bold text-[18px]">이번주 인기 스터디</text>
          <SlArrowRight className="text-black ml-auto" />
        </button>
        <div className="mt-5">
          <Study_Box />
      ...
      <div className="pt-6">
        <button
          ...
          onClick={() => "스터디 이동 링크"}
        >
          <text className="font-bold text-[18px]">새로 개설된 스터디</text>
          <SlArrowRight className="text-black ml-auto" />
        </button>
        <div className="mt-5">
          <Study_Box />
      ...
      <div className="pt-6">
        <button
          ...
          onClick={() => "스터디 이동 링크"}
        >
          <text className="font-bold text-[18px]">스터링 활동 우수 팀원</text>
          <SlArrowRight className="text-black ml-auto" />
        </button>
        <div className="mt-5">
          <Team_Box />
